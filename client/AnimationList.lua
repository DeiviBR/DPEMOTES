...
DP.Shared = {
    ...
    ["punched"] = {
       ...
       ["Knife1"] = {
        "missmic2ig_11",
        "mic_2_ig_11_intro_goon",
        "Knife1",
        "Knife1_B"
    },
       ["Knife1_B"] = {
        "missmic2ig_11",
        "mic_2_ig_11_intro_p_one",
        "Knife1_B",
        "Knife1"
    },
   ["Knife2"] = {
...
DP.PropEmotes = {
    ...
    ["pasta2"] = { -- Added for compatibility
    ...
    ["peso2"] = {
	 ...
	 ["posepeso"] = { -- Custom Emote By Frabi
        "frabi@malepose@solo@firstsport",
        "pose_sport_004",
        "Pose Peso",
        AnimationOptions = {
	 ...
	 ["posepeso2"] = { -- Custom Emote By Frabi
        "frabi@malepose@solo@firstsport",
        "pose_sport_003",
        "Pose Peso 2",
        AnimationOptions = {
    ...
    ["vassoura2"] = {
        ...
        "Vassoura 2",
        AnimationOptions = {
            Prop = "bkr_prop_biker_tool_broom",
            PropBone = 28422,
            PropPlacement = {
                0.0,
                0.03,
    ...
    ["selfie12"] = { -- Emote by WhiskerValeMods
    ...
    ["selfie2"] = { -- Custom Emote By Struggleville
    ...
    ["cadeira4"] = { -- Emote by WhiskerValeMods
        "mouse@femalearmchair",
        "female_armchair_clip_01",
        "Sentando na Cadeira 4",
        AnimationOptions = {
    ...
    ["cadeira5"] = { -- Custom Emote by WhiskerValeMods
        "mouse@female_sitting_folded",
        "female_sitting_folded_clip",
        "Sentando na Cadeira 5",
        AnimationOptions = {
    ...
    ["cadeira6"] = { -- Custom Emote by WhiskerValeMods
        "mouse@female_sitting_forward",
        "female_sitting_forward_clip",
        "Sentando na Cadeira 6",
        AnimationOptions = {
            Prop = "ba_prop_battle_club_chair_03",
            PropBone = 0,
            PropPlacement = { 0.0,
    ...
    ["cadeira7"] = { -- Custom Emote by WhiskerValeMods
        "mouse@female_smart_sitting",
        "female_smart_sitting_clip",
        "Sentando na Cadeira 7",
        AnimationOptions = {
            Prop = "ba_prop_battle_club_chair_03",
            PropBone = 0,
            PropPlacement = { 0.0,
    ...
    ["cadeira9"] = { -- Custom Emote By WhiskerValeMods
        "mouse@female_sitting_laptop",
        "female_sitting_laptop_clip",
        "Sentando na Cadeira 9",
        AnimationOptions = {
    ...
    ["cadeira10"] = { -- Custom Emote By Emote by WhiskerValeMods
        "mouse@female_sitting_tablet",
        "female_sitting_tablet_clip",
        "Sentando na Cadeira 10",
        AnimationOptions = {
    ...
    ["cadeira11"] = { -- Custom Emote By Emote by WhiskerValeMods
        "mouse@female_sitting_tablet",
        "female_sitting_tablet_clip",
        "Sentando na Cadeira 11",
        AnimationOptions = {
    ...
    ["sinalizando2"] = { -- Added for compatibility
        "amb@world_human_car_park_attendant@male@base",
        "base",
        "Sinalizando 2",
        AnimationOptions = {
    ...
    ["maleta2aberta2"] = {
		...
		AnimationOptions = {
            ...
            SecondProp = 'ba_prop_battle_amb_phone',
            SecondPropBone = 28422,
            SecondPropPlacement = {
                0.0050,
                -0.1270,
    ...
    ["megafone"] = { -- Custom Emote By MollyEmotes
        "molly@megaphone",
        "megaphone_clip",
        "Megafone",
        AnimationOptions = {
    ...
    ["megafone2"] = { -- Custom Emote By MollyEmotes
        "molly@megaphone2",
        "megaphone_clip",
        "Megafone 2",
        AnimationOptions = {
    ...
    ["posebasket1"] = { -- Custom Emote By Struggleville
    ...
    ["posebasket2"] = { -- Custom Emote By Struggleville
    ...
    ["macadoamor"] = { -- Custom Prop by hollywoodiownu
        "anim@heists@humane_labs@finale@keycards", 
        "ped_a_enter_loop", 
        "Maça do Amor", 
        AnimationOptions = {
