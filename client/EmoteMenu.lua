...
function AddInfoMenu(menu)
    if not UpdateAvailable then
        infomenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['infoupdate'], "Versão 0.02", "",
            Menuthing, Menuthing)
    else
    ...
    infomenu:AddItem(NativeUI.CreateItem("<font color=\"#a020f0\">Updates</font>",
        "https://github.com/DeiviBR/dpemotes"))
