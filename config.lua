Config = {
    ...
    MenuImage = "https://i.imgur.com/FgjWgFi.png", ----[Custom banner imgur URLs go here ]---
...
Config.Languages = {
    ['en'] = { -- English 🇬🇧
        ...
        ['cancelemoteinfo'] = "~r~X~w~ Cancela os emotes",
        ['walkingstyles'] = "Estilos de Caminha 🚶🏻‍♂️",
        ...
        ['suggestions'] = "~b~Deivi",
        ['suggestionsinfo'] = "~b~Deivi~s~ : Não fui eu que realmente criei o DPEMOTES muito menos RPEMOTES apenas modifiquei.",
        ...
        ['emotemenucmd'] = "Digite /emotemenu para abrir o menu.",
        ...
        ['stun'] = "Pressione ~y~G~w~ para 'usar' arma de choque.",
        ['vape'] = "Pressione ~y~G~w~ para fumar o pendrive.",
        ['bound'] = "Vinculado ",
        ['to'] = "para",
        ...
        ['keybinds'] = "🔢 Keybinds",
        ['keybindsinfo'] = "Usar",
        ['searchemotes'] = "🔍 Pesquisar Emotes",
        ['searchinputtitle'] = "Pesquisar:",
        ['searchmenudesc'] = "%s resultado(s) para '~r~%s~w~':",
        ['searchnoresult'] = "Não existe um emote chamado '~r~%s~w~'.",
        ['searchshifttofav'] = "Segure L-Shift e pressione Enter para definir como favorito.",
        ['searchcantsetfav'] = "Emotes compartilhados não podem ser definidos como favoritos."
    },
    ['cs'] = { -- Czech 🇨🇿
        ['emotes'] = 'Animace 🎬',
